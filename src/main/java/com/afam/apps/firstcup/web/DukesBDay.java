 ...
 */
package com.afam.apps.firstcup.web;

import com.afam.apps.firstcup.ejb.DukesBirthdayBean;
...
public class DukesBDay implements Serializable {
    ...
    private static final Logger logger = Logger.getLogger("com.afam.apps.firstcup.web.DukesBDay");
